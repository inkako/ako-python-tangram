...
def import_models():
    ...
    for package_name in model_packages:
        ...
        for _, mod_name, _ in walk_packages(package.__path__, prefix=package.__name__ + "."):
            logger.info(f"Alembic, scanned package_path: {package.__path__}, package_name: {package.__name__}")
